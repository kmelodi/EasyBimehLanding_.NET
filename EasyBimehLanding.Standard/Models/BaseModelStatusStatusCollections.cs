...
{
    public class BaseModelStatusStatusCollections : BaseModel 
    {
        // These fields hold the values for the public properties.
        private bool isSuccess;
        private int status;
        private List<Models.StatusStatusCollections> message;
        ...
        public List<Models.StatusStatusCollections> Message 
        { 
            get 
            {
                return this.message; 
