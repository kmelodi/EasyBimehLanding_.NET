...
{
    public partial class ThirdPartyInsuranceController: BaseController
    {
        ...
        /// </summary>
        internal static ThirdPartyInsuranceController Instance
        {
            get
            {
                lock (syncObject)
        ...
        /// </summary>
        /// <param name="carTypeGroup">Required parameter: شناسه ی گروه خودرو</param>
        /// <param name="xApiKey">Required parameter: کلید اختصاصی ارتباط با سرور</param>
        /// <return>Returns the Models.CarBrands response from the API call</return>
        public Models.CarBrands GetCarBrands(int carTypeGroup, string xApiKey)
        {
            Task<Models.CarBrands> t = GetCarBrandsAsync(carTypeGroup, xApiKey);
        ...
        /// <param name="xApiKey">Required parameter: کلید اختصاصی ارتباط با سرور</param>
        /// <return>Returns the Models.CarBrands response from the API call</return>
        public async Task<Models.CarBrands> GetCarBrandsAsync(int carTypeGroup, string xApiKey)
        {
            ...
            try
            {
                return APIHelper.JsonDeserialize<Models.CarBrands>(_response.Body);
            }
            catch (Exception _ex)
            {
        ...
        /// <param name="xApiKey">Required parameter: کلید اختصاصی ارتباط با سرور</param>
        /// <return>Returns the Models.RiskLevel response from the API call</return>
        public Models.RiskLevel GetRiskLevel(int insurancePolicyType, string xApiKey)
        {
            Task<Models.RiskLevel> t = GetRiskLevelAsync(insurancePolicyType, xApiKey);
            APIHelper.RunTaskSynchronously(t);
            return t.Result;
        }
        ...
        /// <param name="xApiKey">Required parameter: کلید اختصاصی ارتباط با سرور</param>
        /// <return>Returns the Models.RiskLevel response from the API call</return>
        public async Task<Models.RiskLevel> GetRiskLevelAsync(int insurancePolicyType, string xApiKey)
        {
            //the base uri for api requests
            string _baseUri = Configuration.GetBaseURI();
            ...
            //prepare query string for API call
            StringBuilder _queryBuilder = new StringBuilder(_baseUri);
            _queryBuilder.Append("/ComboData/RiskLevel");
            ...
            try
            {
                return APIHelper.JsonDeserialize<Models.RiskLevel>(_response.Body);
            }
            catch (Exception _ex)
            {
                throw new APIException("Failed to parse the response: " + _ex.Message, _context);
        ...
        /// </summary>
        /// <param name="carTypeId">Required parameter: شناسه ی نوع خودرو</param>
        /// <param name="xApiKey">Required parameter: کلید اختصاصی ارتباط با سرور</param>
        /// <return>Returns the Models.CarUses response from the API call</return>
        public Models.CarUses GetCarUses(int carTypeId, string xApiKey)
        {
            Task<Models.CarUses> t = GetCarUsesAsync(carTypeId, xApiKey);
            APIHelper.RunTaskSynchronously(t);
            return t.Result;
        }
        ...
        /// <param name="xApiKey">Required parameter: کلید اختصاصی ارتباط با سرور</param>
        /// <return>Returns the Models.CarUses response from the API call</return>
        public async Task<Models.CarUses> GetCarUsesAsync(int carTypeId, string xApiKey)
        {
            //the base uri for api requests
            string _baseUri = Configuration.GetBaseURI();
            ...
            //prepare query string for API call
            StringBuilder _queryBuilder = new StringBuilder(_baseUri);
            _queryBuilder.Append("/ComboData/CarUses");
            ...
            try
            {
                return APIHelper.JsonDeserialize<Models.CarUses>(_response.Body);
            }
            catch (Exception _ex)
            {
                throw new APIException("Failed to parse the response: " + _ex.Message, _context);
        ...
        /// <param name="insurancePolicyType">Required parameter: شناسه ی نوع بیمه</param>
        /// <param name="xApiKey">Required parameter: کلید اختصاصی ارتباط با سرور</param>
