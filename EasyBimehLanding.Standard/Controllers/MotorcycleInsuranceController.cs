...
{
    public partial class MotorcycleInsuranceController: BaseController
    {
        ...
        /// </summary>
        internal static MotorcycleInsuranceController Instance
        {
            get
            {
                lock (syncObject)
        ...
        /// </summary>
        /// <param name="carTypeGroup">Required parameter: شناسه ی گروه خودرویی، موتور سیکلت =>0</param>
        ...
        /// </summary>
        /// <param name="carBrandId">Required parameter: شناسه ی برند موتور سیکلت</param>
        /// <param name="xApiKey">Required parameter: کلید اختصاصی ارتباط با سرور</param>
